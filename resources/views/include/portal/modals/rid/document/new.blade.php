    ...
    <div class="modal-header p-2">
     ...
     <div class="row">
      ...
      <div class="col-lg-auto mb-3">
       ...
       <input data-field="required" type="checkbox" data-toggle="toggle" data-off="Periodic" data-on="Required" data-onstyle="success" data-offstyle="light" name="required" checked data-width="120" />
      </div>
     </div>
