<div class="modal fade" id="HealthModal{{ $rid->id }}" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
   <div class="modal-content">
    <div class="modal-header p-2">
     <h5 class="m-0">
      Submit Health Authority / Regulatory Approval
     </h5>
...
<div class="modal fade" id="ReviewHealthModal{{ $rid->id }}" tabindex="-1" role="dialog" aria-hidden="true">
 <form method="post" action="{{ route('eac.portal.rid.modal.user.save') }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  <input type="hidden" name="id" value="{{ $rid->id }}"/>
  <div class="modal-dialog modal-dialog-centered" role="document">
   <div class="modal-content">
    <div class="modal-header p-2">
     <h5 class="m-0">
      Health Authority / Regulatory Approval Review
     </h5>
     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <i class="fal fa-times"></i>
     </button>
    ...
    <div class="modal-body p-3">
     <div class="mb-3">
      <div class="row">
       ...
       <div class="col-sm">
        Does the Health Authority / Regulatory Approval document match with the corresponding drug, physician and patient?
       </div>
      </div>
     </div>
     <hr class="mt-0" />
