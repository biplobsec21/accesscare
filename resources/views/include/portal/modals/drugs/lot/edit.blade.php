    ...
    <div class="modal-body p-3">
     ...
     <div class="row">
      <div class="col-md mb-3">
       ...
       <input type="text" name="stock" class="form-control" required="required" value="{{ $lot->stock}}">
      </div>
      <div class="col-md mb-3">
       <label class="d-block label_required">Minimum</label>
       <input type="text" name="minimum" class="form-control" required="required" value="{{ $lot->minimum}}">
      </div>
     </div>
				</div>
