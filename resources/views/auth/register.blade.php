				...
				<div class="tab-content" id="LoginPContent">
					<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control{{ $errors->has('hospital') ? ' is-invalid' : '' }}"
							       name="hospital" value="{{ old('hospital') }}"/>
							<div class="invalid-feedback">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control mb-1{{ $errors->has('addr1') ? ' is-invalid' : '' }}"
							       name="addr1" value="{{ old('addr1') }}"/>
							<input type="text" class="form-control" name="addr2" value="{{ old('addr2') }}"
							       placeholder="Apartment, Building, Suite, Floor, etc"/>
							<div class="invalid-feedback">
								{{ $errors->first('addr1') }}
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm col-md-8 col-lg-12 col-xl-7 mb-2">
								...
								<select class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}"
									...
									@foreach(\App\Country::select(['id', 'abbr', 'name'])->where('active', '=', true)->sortBy('name') as $country)
