      ...
      <div class="col-sm col-md-12 order-md-2">
       <ul class="nav justify-content-center justify-content-sm-start flex-sm-column">
        ...
        <li class="nav-item active">
         <a class="nav-link disabled" href="early-access-system-platform-root">Early Access System Platform</a>
        </li>
        <li class="nav-item">
         <a class="nav-link" href="post-trail-access--pharmaceutical">Post Trial Access </a>
        </li>
        <li class="nav-item">
