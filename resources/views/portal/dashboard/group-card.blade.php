                ...
                <div class="collapse" id="showGROUPstats">
                    <ul class="list-group list-group-flush mb-0 small">
                        <li class="list-group-item pt-1 pb-1">
                            <a href="{{route('eac.portal.user.group.list') . "?type-name=Physician"}}" title="View All User Groups">
                                <div class="row m-0">
                                    <div class="col p-0">
                                        Physician Groups
                                    </div>
                        ...
                        <li class="list-group-item pt-1 pb-1">
                            <a href="{{route('eac.portal.user.group.list') . "?type-name=Pharmaceutical"}}" title="View All User Groups">
                                <div class="row m-0">
                                    <div class="col p-0">
                        ...
                        <li class="list-group-item pt-1 pb-1">
                            <a href="{{route('eac.portal.user.group.list') . "?type-name=Early%20Access%20Care"}}" title="View All User Groups">
                                <div class="row m-0">
                                    <div class="col p-0">
