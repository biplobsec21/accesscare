 ...
 <div class="titleBar">
  <nav aria-label="breadcrumb">
   <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item">
     <a href="{{ route('eac.portal.settings.manage.drug.dosage.concentration.index') }}">Concentration Unit Manager</a>
    </li>
      ...
      <div class="card card-body mb-0">
       <div class="row">
        ...
        <div class="col-sm col-md-5 col-lg-4 mb-3">
         ...
         <input name="abbr" type="text" value="{{ !empty($rows) ?  $rows[0]->abbr : old('abbr') }}" class="form-control">
        </div>
