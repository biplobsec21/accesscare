      ...
      <div class="card card-body mb-0">
       <div class="row">
        <div class="col-sm mb-3">
         <label class="d-block label_required">Form Label</label>
        ...
        <div class="col-sm col-md-5 col-lg-4 mb-3">
         ...
         <select class="form-control" name="concentration_req"  >
          ...
          <option value="1" {{ old('concentration_req') == '1' ? 'selected' : ''}}>Yes</option>
          <option value="0" {{ old('concentration_req') == '0' ? 'selected' : ''}}>No</option>
         </select>
        </div>
       </div><!-- /.row -->
       <div class="row">
        <div class="col-sm mb-3">
         <label class="d-block label_required">Dosage Route</label>
