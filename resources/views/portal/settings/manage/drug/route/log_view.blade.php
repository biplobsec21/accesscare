...
@section('content')
 <div class="titleBar">
  <nav aria-label="breadcrumb">
   <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item">
     <a href="{{ route('eac.portal.settings.manage.drug.dosage.route.index') }}">Route of Admin Manager</a>
    </li>
  ...
  <h2 class="m-0">
   Route of Admin Manager <small>@yield('title')</small>
  </h2>
 </div><!-- end .titleBar -->
 <div class="actionBar">
 ...
 <div class="viewData">
  <div class="card-header p-2">
   <h5 class="m-0">
    Change Log for <strong><u>{{\App\DosageRoute::where('id','=',request()->id)->firstOrFail()->name}}</u></strong>
   </h5>
  </div>
