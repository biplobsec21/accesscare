...
@section('content')
 ...
 <div class="viewData">
  <div class="card-header p-2">
   <h5 class="m-0">
    Change Log for <strong><u>
      {{-- {{\App\Dosage::where('id','=',request()->id)->firstOrFail()->name}}</u> --}}
         @php $dosages=\App\Dosage::where('id','=',request()->id)->firstOrFail(); @endphp
          {{  $dosages && isset($dosages->form->name) ? $dosages->form->name : request()->id  }}
        </u>
    </strong>
   </h5>
  </div>
