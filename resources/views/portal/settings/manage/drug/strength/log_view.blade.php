...
<div class="actionBar">
    ...
    <div class="col-md-6 text-left">
        ...
        <a href="{{ route('eac.portal.settings.document.type.logs') }}" class="btn btn-primary">
...
<div class="actionBar m-t-20">
    <div class="">
        ...
        <h5>
            ...
            Log list For <span class="text-danger">[{{  \App\DosageStrength::where('id','=',request()->id)->firstOrFail()->name  }}]</span>
        </h5>
    </div>
</div><!-- end .titleBar -->
        ...
        <table class="table table-sm SObasic dt-responsive">
            ...
            <tbody>
                ...
                <tr data-id="{{$val->user_id}}">
                    <?php if($user>0){ ?><td>
                        {{  \App\User ::where('id','=',$val->user_id)->firstOrFail()->first_name  }} {{  \App\User ::where('id','=',$val->user_id)->firstOrFail()->last_name  }}</td>
                       <?php  }else{
                         echo '<td>N/A</td>';
                        } ?>
