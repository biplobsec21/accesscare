      ...
      <div class="card card-body mb-0">
       <div class="row">
        <div class="col-sm mb-3">
         <label class="d-block">Strength Label</label>
       ...
       <div class="mb-3">
        ...
        <textarea name="desc" class="form-control" rows="3">{{ !empty($rows) ?  $rows[0]->desc : '' }}</textarea>
       </div>
      </div>
      ...
      if (isConfirm) {
        swal({
          ...
          icon: 'success'
            ...
            $.get("{{route('eac.portal.settings.manage.drug.dosage.strengthdelete')}}",
              {
               id: param
             });
            // return false;
          ...
          $(location).attr('href', '{{route('eac.portal.settings.manage.drug.dosage.strength.index')}}') // <--- submit form programmatically
        });
      } else {
