  ...
  <div class="card mb-1 mb-md-4">
   ...
   <div class="table-responsive">
    <table class="table table-sm table-striped" id="routeTBL">
     <thead>
      <tr>
       ...
       <th width="8%">Name</th>
       <th width="35%" class="no-sort">Template (PDF or Doc)</th>
       <th>Description</th>
       <th>Last Update</th>
    ...
    <tr>
       ...
       <th width="8%">Name</th>
       <th width="35%" class="no-search">Template (PDF or Doc)</th>
       <th>Description</th>
       <th>Last Update</th>
...
$(document).ready(function () {
 ...
 var dataTable = $('#routeTBL').DataTable({
  ...
  'order': [[1, 'asc']],
  "ajax": {
   url: "{{ route('eac.portal.settings.manage.document.documentAjaxlist') }}",
   type: "post"
  },
  "processing": true,
  "serverSide": true,
 ...
 swal({
  ...
  if (isConfirm) {
   swal({
    ...
    $.get("{{route('documentType.ajaxDelete')}}",
      {
       id: param
      });
    // return false;
    ...
    $(location).attr('href', '{{route('eac.portal.settings.document.type')}}') // <--- submit form programmatically
   });
  } else {
