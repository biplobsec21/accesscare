...
@section('content')
	...
	<div class="actionBar">
		...
		@if(\Auth::user()->type->name == 'Early Access Care')
			...
			@endif
		@endif
		<a href="{{ route('eac.portal.drug.show', $drug->id) }}" class="ml-xl-auto btn btn-warning">
					...
					<div class="tab-pane fade" id="xwebdesc" role="tabpanel" aria-labelledby="xwebdesc-tab">
						<form method="post" action="{{ route('eac.portal.drug.description.update',$drug->id) }}" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								{{-- .basic-editor commented out, google was detecting privacy errors and not allowing page to load 2019-08-15 --}}
							</div>
							<div class="card-footer">
								<button type="submit" class="btn btn-success">Save Changes</button>
							</div>
