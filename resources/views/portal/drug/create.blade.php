...
@section('content')
	...
	<form method="post" action="{{ route('eac.portal.drug.store') }}" enctype="multipart/form-data">
		...
		<div class="actionBar">
			...
			<a href="{{ route('eac.portal.drug.list') }}" class="ml-xl-auto btn btn-warning">
					...
					<div class="card tab-content wizardContent" id="tabContent">
						<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
							<div class="card-body">
								...
								<div class="mb-3">
									...
									<select class="form-control select2{{ $errors->has('company_id') ? ' is-invalid' : '' }}" name="company_id">
										@if(Auth::user()->company_id)
											<option value="{{ Auth::user()->company->id }}" selected>{{ Auth::user()->company->name }}</option>
										@else
								...
								<div class="row">
									<div class="col-md mb-3">
										<label class="d-block">Drug image
