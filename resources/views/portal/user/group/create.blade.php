                                ...
                                @if(\Auth::user()->type->name == 'Early Access Care')
                                    <div class="row">
                                        <div class="col-sm mb-3">
                                            ...
                                            <select name="parent_id" id="parent_id" class="form-control select2 {{ $errors->has('parent_id') ? ' is-invalid' : '' }}">
                                                <option disabled hidden selected value="">-- Select --</option>
                                                @foreach($users as $user)
                                                    <option value="{{ $user->id }}" data-type="{{ $user->type->id }}" {{ (old('parent_id') && old('parent_id') == $user->id) ? 'selected' : '' }}>{{ $user->full_name }} ({{ $user->email }})
                                                    </option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm col-lg-5 mb-3">
                                            ...
                                            <select name="type_id" id="type_select" class="form-control {{ $errors->has('type_id') ? ' is-invalid' : '' }}">
                                                <option disabled hidden selected value="">-- Select --</option>
                        ...
                        <div class="tab-pane fade" id="xusers" role="tabpanel" aria-labelledby="xusers-tab">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    ...
                                    <a href="{{ route('eac.portal.user.create') }}" target="_blank" class="btn btn-secondary">
                                        <i class="fa-fw fal fa-user-plus"></i>
                                        Add New User
                                    </a>
                                </div>
                            </div>
