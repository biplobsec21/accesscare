            ...
            <div class="row thisone m-0 mb-xl-5">
                <div class="col-sm-3 col-xl-auto mb-2 mb-sm-0 p-0">
                    <div class="wizardSteps symbols nav flex-row flex-sm-column mt-sm-3" id="tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="xusers-tab" data-toggle="pill" href="#xusers" role="tab" aria-controls="xusers" aria-selected="false">
                                    ...
                                    <div class="col-sm col-lg-5 mb-3">
                                        ...
                                        <select name="type_id" id="type_select" class="form-control">
                                            ...
                                            @foreach(\App\UserType::all()->sortBy('name') as $type)
                                                <option value="{{ $type->id }}" @if($type->id == $group->type_id) selected @endif>{{ $type->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm mb-3">
                                        ...
                                        <select name="parent_id" id="parent_id" class="form-control select2">
                                            ...
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}" data-type="{{ $user->type->id }}" @if($user->id == $group->parent_user_id) selected @endif>{{ $user->full_name }} ({{ $user->email }})
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                            ...
                                            @foreach($group->members() as $member)
                                                <tr class="group-member">
                                                    <td>
                                                        ...
                                                        <select class="form-control update" name="member[{{$i}}]" style="display: none">
                                                            <option hidden value="">-- User --</option>
                                                            @foreach($users as $user)
                                                                <option value="{{$user->id}}" data-typeid="{{ $user->type_id }}" @if($member->user->id == $user->id) selected @endif>
                                                                    {{ $user->full_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select class="form-control update" name="role[{{$i}}]" style="display: none">
                                                            <option hidden value="">-- Role --</option>
                                                            @foreach(\App\Role::all()->sortBy('name') as $role)
                                                                <option value="{{$role->id}}" data-typeid="{{ $role->type_id }}" @if($member->role->id == $role->id) selected @endif>
                                                                    {{ $role->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
