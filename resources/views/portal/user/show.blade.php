  ...
  <div class="row thisone m-0 mb-xl-5">
   ...
   <div class="col-sm-9 col-xl p-0">
    <div class="tab-content wizardContent" id="tabContent">
     ...
     </div><!-- /.tab-pane -->@access('rid.info.view')
...
// {"data": "visits"},
   ...
   $.fn.dataTable.ext.errMode = function (settings, helpPage, message) {
    swal({
     title: "Oh Snap!",
     text: "There was an error understanding this request. If this issue persists, <a href="
     mailto: {{site()->email}}">click her</a> to contact us.",
     icon: "warning",
    });
   };
