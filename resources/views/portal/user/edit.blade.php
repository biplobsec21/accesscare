...
@section('content')
    ...
    <div class="viewData">
        ...
        <div class="bg-dark text-white pt-2 pb-2 pr-3 pl-3 d-flex justify-content-between">
            ...
            <a href="{{ route('eac.portal.user.userWelcome', $user->id) }}" class="btn btn-info">
        ...
        <div class="row thisone m-0 mb-xl-5">
            ...
            <div class="col-sm-9 col-lg-7 col-xl p-0">
                <div class="tab-content wizardContent" id="tabContent">
                    ...
                    <div class="tab-pane fade card" id="xassigned" role="tabpanel" aria-labelledby="xassigned-tab">
                        <div class="card-body">
