    ...
    <div class="col-md-6 col-xl-4">
     <div class="card card-body p-3 mb-3">
   			@if($document->type == 'Uploadable')
   				<h5 class="mb-0 strong">{{$document->name}}</h5>
        ...
        <div class="d-flex justify-content-between mt-2 flex-wrap">
         ...
         <div class="">
          <a title="Edit" class="btn btn-info btn-sm" data-toggle="modal" data-target="#UploadModal{{$document->id}}" href="#UploadModal{{$document->id}}" aria-hidden="true">
        ...
        <div class="alert alert-success p-2 mb-n2 mt-2 d-flex justify-content-between align-items-center">
         <h6 class="m-0 strong text-success"><i class="far fa-check"></i> Uploaded</h6>
         <a title="Review" class="btn btn-success btn-sm" data-toggle="modal" data-target="#UploadReviewModal{{$document->id}}" href="#UploadReviewModal{{$document->id}}" aria-hidden="true">
          <span class="fal fa-search"></span> Review
         </a>
        </div>
   				@else
        <div class="mt-2 ">
         <a title="Add" class="btn btn-warning" data-toggle="modal" data-target="#UploadModal{{$document->id}}" href="#UploadModal{{$document->id}}" aria-hidden="true">
    						<i class="fad fa-upload"></i> Upload Required
    					</a>
        </div>
   				@endif
       ...
       <h5 class="mb-0 strong">{{$document->name}}</h5>
        @if($doc && ($doc->is_acknowledged == 1))
         <div class="alert alert-success p-2 mb-n2 mt-2 d-flex justify-content-between align-items-center">
          <h6 class="mt-1 mb-1 strong text-success"><i class="far fa-check"></i> Acknowledgement Complete</h6>
         </div>
        @else
         <div class="mt-2 ">
          <a title="Add" class="btn btn-warning" data-toggle="modal" data-target="#AcknowledgeModal{{$document->id}}" href="#AcknowledgeModal{{$document->id}}" aria-hidden="true">
           <i class="fad fa-notes-medical"></i> Acknowledgement Required
          </a>
         </div>
        @endif
