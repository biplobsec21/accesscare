<div class="visitData">
 <div class="row">
  ...
  <div class="col-auto">
   ...
   <a href="#editReqForms" data-toggle="modal" class="btn btn-info btn-sm">
    <i class="fal fa-edit"></i> Edit Forms
   </a>
   <form method="post" action="{{ route('eac.portal.rid.document.required.update') }}">
    @csrf
    <div class="modal fade" id="editReqForms" tabindex="-1" role="dialog"
      aria-labelledby="editReqFormsLabel"
      aria-hidden="true">
 ...
 <div class="mt-3">
  <button type="button" class="btn btn-success window-btn" data-toggle="modal"
   ...
   <i class="fal fa-plus"></i> New Form
  </button>
 </div>
