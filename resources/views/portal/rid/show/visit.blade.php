<div class="shadow-none card tab-pane fade" id="xdetails{{$visit->index}}" role="tabpanel" aria-labelledby="xdetails{{$visit->index}}-tab">
    <div class="bg-dark text-white pt-2 pb-2 pr-3 pl-3 pl-sm-0 d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-light btn-sm" data-toggle="collapse" href=".multi-collapse" role="button" aria-expanded="false" aria-controls="details-1-{{$visit->id}} details-2-{{$visit->id}} details-3-{{$visit->id}}">
    ...
    <div class="pt-3 pl-3 pb-2 pr-3 alert-light text-dark border border-light">
        <div class="row">
            <div class="col-auto col-lg-3 mb-2 col-xl-auto text-lg-center mb-lg-0">
                <span class="badge badge-{{$visit->status->badge}}">{{ $visit->status->name }}</span>
            </div>
    ...
    <div class="visitData pl-3 pr-3 mb-3 mb-xl-4">
        <div class="row">
            ...
            <div class="col-auto">
                <a class="btn btn-dark btn-sm" data-toggle="collapse" href="#details-2-{{$visit->id}}" role="button" aria-expanded="false" aria-controls="details-2-{{$visit->id}}">
                    Show More
                </a>
            </div>
        </div>
    ...
    <div class="visitData pl-3 pr-3 mb-3 pb-3 mb-xl-4">
        <div class="row">
            ...
            <div class="col-auto">
                <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#NoteAdd{{$visit->id}}">
                    Add Note to Visit
                </a>
            </div>
            <div class="col-auto">
                <a class="btn btn-dark btn-sm" data-toggle="collapse" href="#details-4-{{$visit->id}}" role="button" aria-expanded="false" aria-controls="details-4-{{$visit->id}}">
                    Show More
                </a>
            </div>
        </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header p-2">
                            <h5 class="m-0">
                                Add Note to
                                <strong>Visit {{ $visit->index }}</strong>
                            </h5>
