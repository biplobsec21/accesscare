...
class DocumentController extends Controller
{
	...
	public function storeRidUpload(Request $request)
	{
		...
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Uploaded File!']);
	}
	...
	public function storeRedacted(Request $request)
	{
		...
		$document->save();
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Added Redacted File!']);
	}
	...
	public function storeRidForm(Request $request)
	{
		...
		$document->save();
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Document Added Successfully']);
	}
	...
	public function storeDrugDoc(CreateRequest $request)
	{
		...
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Document Added Successfully'])->with('sweet_alert', $sweetAlert);
	}
	...
	public function storeDrugResource(CreateRequest $request)
	{
		...
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Resource Added Successfully'])->with('sweet_alert', $sweetAlert);
		// return redirect()->back();
	}
	...
	public function updateDrugDoc(Request $request)
	{
		...
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Document Updated Successfully'])->with('sweet_alert', $sweetAlert);
	}
	...
	public function updateResource(Request $request)
	{
		...
		return redirect()->back()->with("alerts", ['type' => 'success', 'msg' => 'Resource Updated Successfully']);
	}
